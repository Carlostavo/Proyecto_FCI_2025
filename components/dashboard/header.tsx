  ...
  return (
    <header className="flex items-start justify-between gap-4 border-b border-border bg-card px-6 py-4">
      <div className="min-w-0">
        <h1 className="truncate text-lg font-semibold text-foreground">Proyecto FCI 2025</h1>
        <p className="truncate text-sm text-muted-foreground">
          Programa de formación y apoyo técnico para el emprendimiento de mujeres indígenas
